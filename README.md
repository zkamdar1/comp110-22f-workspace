...
7. Select the `backup` remote that is your personal workspace on GitHub. If you do not see `backup` listed, see the instructions below on _Setup Backup Course Material Repository_.
   ...
   - `https://github.com/comp110-22f/comp110-workspace-22f-USERNAME`
...
1. Navigate a web browser to <https://classroom.github.com/a/hbIteCh0>
...
5. Click the link to your personal backup repository that looks something like this `https://github.com/comp110-22f/comp110-workspace-22f-krisjordan` (except instead of `krisjordan` you will see your GitHub username).
